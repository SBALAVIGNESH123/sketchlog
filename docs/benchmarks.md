...
The following chart plots total `StreamLog` memory using the default C++ backend on Python 3.11 for a stream generated by `random.uniform(1.0, 1000.0)` (seed `42`).
